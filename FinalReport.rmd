...
$H_0:$ Drug users get aids 
$H_a$ Drug users dont get aids 
...
drugUserData = filter (drugUserdata, drugUserdata=='yes) 
```
...
```
  ...
  The percent barchart shows people with aids had a higher percentage of placebo versus people that does not have aids. People that does not have aids have about the same percentage as the placebo. 
